      ...
      <div className="mt-md">
        <h3>
          <a href="https://josebenedicto.com/ffxiv/cross-hotbar-settings--auto-switching-for-battle">
            Configure the Cross Hotbar UI to Auto-Switch for Combat
          </a>
        </h3>

        <p>
          How to configure your Cross Hotbar UI settings in Controller Mode to automatically switch between a combat and passive hotbar  when entering and exiting battle.
        </p>
