        ...
        preferencesModal: {
          ...
          sections: [
            ...
            },
            {
              ...
              <ul>\
              <li><code>Host-next-auth.*</code> – Used for user authentication and session state</li>\
              <li><code>Secure-next-auth.*</code> – Used for user authentication and session state</li>\
              </ul>',
            ...
            },
            {
              ...
              \<br\><br\>\
              Cookies named <code>_gads</code>, <code>_gpi</code>, and <code>_eoi</code> are third-party cookies set on the website domain. These cookies are used by Google Ad Manager on behalf of the website to support:\
              \
              <ul>\
              <li>Programmatic buyers frequency capping and ads personalization</li>\
              <li>Reservation frequency capping</li>\
              </ul>',
              linkedCategory: 'ads'
            },
            {
