const enUS = {
  Global: {
    ...
    description: 'Plan out and export your Final Fantasy XIV Endwalker WXHB Cross Hotbars for any of the FFXIV Endwalker Job/Classes with a drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar slot layout. Export to a macro and share with others!',
    close: '× Close'
  },
  Header: {
