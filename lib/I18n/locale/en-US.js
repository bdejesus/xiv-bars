module.exports = {
  Global: {
    title: 'FFXIV Endwalker WXHB Cross Hotbar Planner/Simulator',
    subtitle: 'A Final Fantasy XIV W Cross Hotbar (WXHB) Planning and Simulation Tool.',
    description: 'Plan out and export your Final Fantasy XIV Endwalker WXHB Cross Hotbars for any of the FFXIV Job/Classes with a drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar slot layout. Export to a macro and share with others!',
    close: '× Close'
  },
  Header: {
    title: 'Simulate and Export FFXIV Endwalker Cross Hotbars for PC or PS4/PS5',
