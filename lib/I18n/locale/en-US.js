const enUS = {
  Global: {
    title: 'Final Fantasy XIV W Cross Hotbar (XHB/WXHB) Planner and Simulator – XIVBARS',
    subtitle: 'A Final Fantasy XIV Cross Hotbar (XHB/WXHB) Planning and Simulation Tool.',
    description: "The Final Fantasy XIV Cross Hotbar Planning and Simulation Tool allows you to plan and export your Endwalker Cross Hotbars (XHB) for each job or class. This tool features a drag-and-drop interface, making it easy to slot in actions, menu commands, macros, and other action types into a hotbar or cross hotbar layout. Once you've finished planning, you can export your hotbar setup as a macro and share it with others. Our tool is the perfect resource for optimizing your FFXIV gameplay experience.",
    close: '× Close',
    loading: 'Loading...'
  },
  ...
  BuyMeABeer: {
    tips_appreciated: 'Tips help keep the servers up!',
    cheers: 'Cheers!',
    donate: 'If you find this tool useful, please donate.'
  },

  ControlBar: {
    CopyLayout: {
      copy_label: 'Copy Layout',
      copy_layout: 'Copy as a new layout'
    },
    ToggleMaxLvl: {
      all_levels: 'All levels',
      all_levels_icon: 'All levels icon'
    },
    ToggleSaveForm: {
  ...
  ExportToMacro: {
    export_to_macro: 'Macro',
    limitations: 'Due to limitations to the FFXIV macro subcommands, only certain actions can assigned via this method. Incompatible actions are grayed out and ommited from the generated macro. ALso note that Macros are limited to 15 lines each.',
    copy: 'Copy',
    copied: 'Copied!'
  },
  ...
  Intro: {
    select_a_job: 'Select a Job/Class',
  },
  ...
  SaveForm: {
    title: 'Title',
    description: 'Description (Required to display this publicly)',
