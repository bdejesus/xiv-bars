module.exports = {
  Global: {
    ...
    description: 'Plan out your Final Fantasy XIV WXHB Cross Hotbars for any of the FFXIV Job/Classes with this simulator. Use the drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar slot layout. Export to a macro and share with others!',
    close: '× Close'
  },
  Header: {
    title: 'Simulate and Export FFXIV Cross Hotbars for PC or PS4',
    body: 'FFXIV WXHB Cross Hotbar Planner/Simulator can be used to simulate and export hotbars for PC or Playstation 4. Configurations are shareable using a generated URL so you can share with others.'
  },
  Footer: {
