const enUS = {
  Global: {
    ...
    description: 'Plan and export your Final Fantasy XIV Endwalker Cross Hotbars (XHB) for each Job/Class. Drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar layout. Export to a macro and share with others!',
    close: '× Close',
    loading: 'Loading...'
  },
