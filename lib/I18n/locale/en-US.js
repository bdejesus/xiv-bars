const enUS = {
  Global: {
    ...
    description: "Plan and customize your FFXIV: Endwalker Cross Hotbars (XHB). User-friendly with a drag-and-drop interface, easily add actions, commands, macros, and more to your hotbar layout. Once you're done, export your setup to a macro.",
    close: '× Close',
    loading: 'Loading...'
  },
  ...
  BuyMeABeer: {
    ...
    cheers: 'Cheers!',
    donate: 'Consider donating if you find this tool useful.'
  },
