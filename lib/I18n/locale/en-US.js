const enUS = {
  Global: {
    title: 'XIVBARS – A Final Fantasy XIV Cross Hotbar (XHB/WXHB) Planner and Simulator',
    subtitle: 'A Final Fantasy XIV Cross Hotbar (XHB/WXHB) Planning and Simulation Tool.',
    description: 'Plan out and export your Final Fantasy XIV Endwalker Cross Hotbars (XHB) for each Job/Class. Drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar layout. Export to a macro and share with others!',
    close: '× Close',
    loading: 'Loading...'
  },
  Header: {
    title: 'Simulate and Export FFXIV Endwalker Cross Hotbars for PC or Playstation 4/5',
    body: 'XIVBars is a FFXIV Cross Hotbar (XHB/WXHB) Planner for simulating the in-game control UI. You can export hotbars for PC or Playstation 4/5 via macros. Configurations are shareable using a generated URL so you can share with others or generate a macro command to import to the game.'
  },
  Footer: {
  ...
  BuyMeABeer: {
    ...
    cheers: 'Cheers!',
    donate: 'If you find this tool useful, please consider donating'
  },
  Lore: {
    lore: 'Lore'
  },
  ...
  ControlBar: {
    ...
    ToggleSaveForm: {
      ...
      publish: 'Publish',
      edit: 'Edit',
      signin: 'Sign in via Discord in to save your layouts',
