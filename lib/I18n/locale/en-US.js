const enUS = {
  Global: {
    title: 'FFXIV XHB/WXHB Cross Hotbar Planner',
    subtitle: 'A Final Fantasy XIV Cross Hotbar (XHB/WXHB) Planning and Simulation Tool.',
    description: 'Plan out and export your Final Fantasy XIV Endwalker XHB Cross Hotbars for each Job/Class. Drag and drop interface to slot actions, menu commands, macros, and other action types into a hotbar or cross hotbar layout. Export to a macro and share with others!',
    close: '× Close',
    loading: 'Loading...'
  },
  Header: {
    title: 'Simulate and Export FFXIV Endwalker Cross Hotbars for PC or Playstation 4/5',
    body: 'FFXIV XHB/WXHB Cross Hotbar Planner is a tool to simulate an in-game UI. You can export hotbars for PC or Playstation 4 via macros. Configurations are shareable using a generated URL so you can share with others or generate a macro command to import to the game.'
  },
  Footer: {
